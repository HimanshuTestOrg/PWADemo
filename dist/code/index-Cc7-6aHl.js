 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const pr=(r,t)=>t===void 0?r?._$litType$!==void 0:r?._$litType$===t;var V=Symbol(),Z=Symbol(),it,nt=new Map,$=class extends E{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(r,t){var e;let o;if(t?.spriteSheet){this.svg=v`<svg part="svg">
...
`;var mr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,le=(r,t,e,o)=>{for(var s=o>1?void 0:o?vr(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&mr(t,e,s),s};let Q=class extends C{constructor(){super(...arguments),this.message="Welcome!"}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}async getContacts(){if(navigator.contacts){const r=["name","email","tel","address","icon"],t={multiple:!0};try{await navigator.contacts.select(r,t)}catch{}}}async getFile(){const[r]=await window.showOpenFilePicker();return await r.getFile()}render(){return v`
      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-button href="${X("about")}" variant="primary"
...
//# sourceMappingURL=index-Cc7-6aHl.js.map
