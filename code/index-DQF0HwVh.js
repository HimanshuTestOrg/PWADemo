...
\f\r]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Et=/-->/g,kt=/>/g,E=RegExp(`>|${ot}(?:([^\\s"'>=/]+)(${ot}*=${ot}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Pt=/'/g,Lt=/"/g,Wt=/^(?:script|style|textarea|title)$/i,we=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),v=we(1),U=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ut=new WeakMap,P=L.createTreeWalker(L,129);function Kt(r,t){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return St!==void 0?St.createHTML(t):t}const $e=(r,t)=>{const e=r.length-1,o=[];let s,i=t===2?"<svg>":"",n=T;for(let l=0;l<e;l++){const a=r[l];let c,b,u=-1,g=0;for(;g<a.length&&(n.lastIndex=g,b=n.exec(a),b!==null);)g=n.lastIndex,n===T?b[1]==="!--"?n=Et:b[1]!==void 0?n=kt:b[2]!==void 0?(Wt.test(b[2])&&(s=RegExp("</"+b[2],"g")),n=E):b[3]!==void 0&&(n=E):n===E?b[0]===">"?(n=s??T,u=-1):b[1]===void 0?u=-2:(u=n.lastIndex-b[2].length,c=b[1],n=b[3]===void 0?E:b[3]==='"'?Lt:Pt):n===Lt||n===Pt?n=E:n===Et||n===kt?n=T:(n=E,s=void 0);const m=n===E&&r[l+1].startsWith("/>")?" ":"";i+=n===T?a+ye:u>=0?(o.push(c),a.slice(0,u)+jt+a.slice(u)+A+m):a+A+(u===-2?l:m)}return[Kt(r,i+(r[e]||"<?>")+(t===2?"</svg>":"")),o]};class j{constructor({strings:t,_$litType$:e},o){let s;this.parts=[];let i=0,n=0;const l=t.length-1,a=this.parts,[c,b]=$e(t,e);if(this.el=j.createElement(c,o),P.currentNode=this.el.content,e===2){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(s=P.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const u of s.getAttributeNames())if(u.endsWith(jt)){const g=b[n++],m=s.getAttribute(u).split(A),y=/([.?@])?(.*)/.exec(g);a.push({type:1,index:i,name:y[2],strings:m,ctor:y[1]==="."?Ae:y[1]==="?"?Ce:y[1]==="@"?Se:et}),s.removeAttribute(u)}else u.startsWith(A)&&(a.push({type:6,index:i}),s.removeAttribute(u));if(Wt.test(s.tagName)){const u=s.textContent.split(A),g=u.length-1;if(g>0){s.textContent=J?J.emptyScript:"";for(let m=0;m<g;m++)s.append(u[m],D()),P.nextNode(),a.push({type:2,index:++i});s.append(u[g],D())}}}else if(s.nodeType===8)if(s.data===Ft)a.push({type:2,index:i});else{let u=-1;for(;(u=s.data.indexOf(A,u+1))!==-1;)a.push({type:7,index:i}),u+=A.length-1}i++}}static createElement(t,e){const o=L.createElement("template");return o.innerHTML=t,o}}function B(r,t,e=r,o){if(t===U)return t;let s=o!==void 0?e._$Co?.[o]:e._$Cl;const i=H(t)?void 0:t._$litDirective$;return s?.constructor!==i&&(s?._$AO?.(!1),i===void 0?s=void 0:(s=new i(r),s._$AT(r,e,o)),o!==void 0?(e._$Co??=[])[o]=s:e._$Cl=s),s!==void 0&&(t=B(r,s._$AS(r,t.values),s,o)),t}class xe{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:o}=this._$AD,s=(t?.creationScope??L).importNode(e,!0);P.currentNode=s;let i=P.nextNode(),n=0,l=0,a=o[0];for(;a!==void 0;){if(n===a.index){let c;a.type===2?c=new q(i,i.nextSibling,this,t):a.type===1?c=new a.ctor(i,a.name,a.strings,this,t):a.type===6&&(c=new Ee(i,this,t)),this._$AV.push(c),a=o[++l]}n!==a?.index&&(i=P.nextNode(),n++)}return P.currentNode=L,s}p(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,o,s){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=B(this,t,e),H(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==U&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):_e(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==f&&H(this._$AH)?this._$AA.nextSibling.data=t:this.T(L.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=j.createElement(Kt(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===s)this._$AH.p(e);else{const i=new xe(s,this),n=i.u(this.options);i.p(e),this.T(n),this._$AH=i}}_$AC(t){let e=Ut.get(t.strings);return e===void 0&&Ut.set(t.strings,e=new j(t)),e}k(t){qt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,s=0;for(const i of t)s===e.length?e.push(o=new q(this.S(D()),this.S(D()),this,this.options)):o=e[s],o._$AI(i),s++;s<e.length&&(this._$AR(o&&o._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class et{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,o,s,i){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=i,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=f}_$AI(t,e=this,o,s){const i=this.strings;let n=!1;if(i===void 0)t=B(this,t,e,0),n=!H(t)||t!==this._$AH&&t!==U,n&&(this._$AH=t);else{const l=t;let a,c;for(t=i[0],a=0;a<i.length-1;a++)c=B(this,l[o+a],e,a),c===U&&(c=this._$AH[a]),n||=!H(c)||c!==this._$AH[a],c===f?t=f:t!==f&&(t+=(c??"")+i[a+1]),this._$AH[a]=c}n&&!s&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ae extends et{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}class Ce extends et{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}}class Se extends et{constructor(t,e,o,s,i){super(t,e,o,s,i),this.type=5}_$AI(t,e=this){if((t=B(this,t,e,0)??f)===U)return;const o=this._$AH,s=t===f&&o!==f||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,i=t!==f&&(o===f||s);s&&this.element.removeEventListener(this.name,this,o),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Ee{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){B(this,t)}}const ke=ft.litHtmlPolyfillSupport;ke?.(j,q),(ft.litHtmlVersions??=[]).push("3.1.2");const Pe=(r,t,e)=>{const o=e?.renderBefore??t;let s=o._$litPart$;if(s===void 0){const i=e?.renderBefore??null;o._$litPart$=s=new q(t.insertBefore(D(),i),i,void 0,e??{})}return s._$AI(r),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let C=class extends O{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return U}};C._$litElement$=!0,C.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:C});const Le=globalThis.litElementPolyfillSupport;Le?.({LitElement:C});(globalThis.litElementVersions??=[]).push("4.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Qt=Ge(class extends Je{constructor(r){if(super(r),r.type!==Ye.ATTRIBUTE||r.name!=="class"||r.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(t=>r[t]).join(" ")+" "}update(r,[t]){if(this.st===void 0){this.st=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(t)}const e=r.element.classList;for(const o of this.st)o in t||(e.remove(o),this.st.delete(o));for(const o in t){const s=!!t[o];s===this.st.has(o)||this.nt?.has(o)||(s?(e.add(o),this.st.add(o)):(e.remove(o),this.st.delete(o)))}return U}});var Xt=class extends S{constructor(){super(...arguments),this.hasSlotController=new Yt(this,"footer","header","image")}render(){return v`
    ...
    `}};Xt.styles=[rt,je];Xt.define("sl-card");var Qe=w`
  :host {
    --track-width: 2px;
...
`,ct="";function zt(r){ct=r}function sr(r=""){if(!ct){const t=[...document.getElementsByTagName("script")],e=t.find(o=>o.hasAttribute("data-shoelace"));if(e)zt(e.getAttribute("data-shoelace"));else{const o=t.find(i=>/shoelace(\.min)?\.js($|\?)/.test(i.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));let s="";o&&(s=o.getAttribute("src")),zt(s.split("/").slice(0,-1).join("/"))}}return ct.replace(/\/$/,"")+(r?`/${r.replace(/^\//,"")}`:"")}var ir={name:"default",resolver:r=>sr(`assets/icons/${r}.svg`)},nr=ir,Nt={caret:`
  ...
  `},ar={name:"system",resolver:r=>r in Nt?`data:image/svg+xml,${encodeURIComponent(Nt[r])}`:""},lr=ar,cr=[nr,lr],dt=[];function dr(r){dt.push(r)}function hr(r){dt=dt.filter(t=>t!==r)}function Vt(r){return cr.find(t=>t.name===r)}var ur=w`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;var mr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,le=(r,t,e,o)=>{for(var s=o>1?void 0:o?vr(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&mr(t,e,s),s};let X=class extends C{constructor(){super(...arguments),this.message="Welcome!"}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}async getContacts(){if(navigator.contacts){const r=["name","email","tel","address","icon"],t={multiple:!0};try{await navigator.contacts.select(r,t)}catch{}}}async getFile(){const[r]=await window.showOpenFilePicker();return await r.getFile()}qr(){"BarcodeDetector"in globalThis?(console.log("Barcode Detector supported!"),new BarcodeDetector({formats:["code_39","codabar","ean_13"]})):console.log("Barcode Detector is not supported by this browser.")}setAppBadge(){navigator.setAppBadge(30)}render(){return v`
      ...
      <main>
        <div id="welcomeBar">
          <sl-card id="welcomeCard">
            ...
            <div>
              ${"share"in navigator?v`<sl-button
                    slot="footer"
                    variant="primary"
                    @click="${this.share}"
                    >Share this Starter!</sl-button
                  >`:null}
              ${"contacts"in navigator?v`<sl-button
                    slot="footer"
                    style="margin-left:10px"
                    variant="primary"
                    @click="${this.getContacts}"
                    >Contact list!</sl-button
                  >`:null}
            </div>
            <div>
              ${"share"in navigator?v`<sl-button
              ...
              ${"share"in navigator?v`<sl-button
                    ...
                    variant="primary"
                    @click="${this.getFile}"
                    >File Manager!</sl-button
                  >`:null}
            </div>
            <div>
              ${"setAppBadge"in navigator?v`<sl-button
                    slot="footer"
                    style="margin-top:10px"
                    variant="primary"
                    @click="${this.setAppBadge}"
                    >Set App Badge!</sl-button
                  >`:null}
            </div>
          </sl-card>
          ...
          <sl-button href="${Q("about")}" variant="primary"
    ...
    `];le([h()],X.prototype,"message",2);X=le([gt("app-home")],X);var yr=Object.defineProperty,_r=Object.getOwnPropertyDescriptor,wt=(r,t,e,o)=>{for(var s=o>1?void 0:o?_r(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&yr(t,e,s),s};let F=class extends C{constructor(){super(...arguments),this.title="PWA Starter",this.enableBack=!1}render(){return v`
      <header>
